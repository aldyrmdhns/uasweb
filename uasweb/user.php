...
<html>
    ...
    <body>
            ...
            <nav>
                ...
                <div class="nav-links">
                    <ul>
                        ...
                        <li> <a href="pages/produk.php"> PRODUCT </a></li>
        ...
        <div class="text-box">
            ...
            <p id="isi"> Pembuatan segala perlengkapan rumah idaman anda mulai dari pintu, jendela,
                lemari, meja, kursi dan lainnya!<br/> percayakan kepada kami, keindahan dimulai dari
                segala detail kecil
            </p>
            <a href="pages/visit-us.html" class="button"> Visit Us to know more!</a>
        </div>
