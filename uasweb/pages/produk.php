...
<html>
    ...
    <body>
        <header class="sub-head-2">
            <nav>
                <a href="user.php"><img src="images/logo.png"></a>
                <div class="nav-links">
                    <ul>
        ...
        <div class="nav-product">
            <div class="nav-col">
                <ul>
                    ...
                    <li> <a href="produk-pages/produk-meja.php"> Meja </a> </li>
                    <li> <a href="produk-pages/produk-lemari.php"> lemari </a></li> 
                    <li> <a href="produk-pages/produk-pintu.php"> Pintu </a> </li>
                    <li> <a href="produk-pages/produk-aksesoris.php"> Aksesoris </a> </li>
                </ul>
            </div>
        </div>
